                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Edite</th>
 ...
 ?>  
                                        <tr>
                                            ...
                                            <td><a href="../php/delete_file.php?id=<?php echo $view[$i]['ID'];?>&path=<?php echo $view[$i]['Path']?> "  ><button type="button" class="close" aria-label="Close">
