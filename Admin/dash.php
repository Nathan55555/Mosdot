                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title"><a href="liste.php">Total Files</a> </h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <li class="ms-auto"><span class="counter text-success"><?php echo $file; ?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title"><a href="liste_users.php">Total Users</a> </h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                                ...
                                <li class="ms-auto"><span class="counter text-purple"><?php echo $user; ?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Demande En cours</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                                ...
                                <li class="ms-auto"><span class="counter text-info"><?php echo $demande ;?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
